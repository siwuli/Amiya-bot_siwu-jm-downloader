...
> 插件 id：`siwu-jm-downloader`　当前版本：`1.1.5`
...
| 版本 | 更新内容 |
|---|---|
| `1.1.5` | 文件发送失败重试间隔从 5 秒拉长到 30 秒，避开 QQ Highway 服务端风控窗口（102902），提高大文件重试成功率 |
| `1.1.4` | OneBot v11 文件发送改为直连 HTTP 接口并放宽超时到 10 分钟，修复大文件上传被框架默认 5 分钟超时掐断的问题 |
